module.exports = {
  ...
  homebrew: [['version', 'homebrew/v/fish'], ['version', 'homebrew/v/cake']],
  'chrome extension': [
  ...
  codecov: [
    ...
    [
      'coverage (bitbucket, branch)',
      '/codecov/c/bitbucket/ignitionrobotics/ign-math/master'
    ],
  ...
  keybase: [['pgp', 'keybase/pgp/lukechilds']]
}
